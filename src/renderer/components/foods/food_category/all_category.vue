    ...
    <div class="hero-body">
        <div class="container">
            ...
            <section>
                <div class="columns">
                    <div class="column">
                        <router-link class="button is-primary" :to="{name:'food_category_add'}">Add New</router-link>
                    </div>
                    <div class="column">
                ...
                >
                    ...
                    <template slot-scope="props">
                        ...
                        <b-table-column field="id" label="Update" >
                            ...
                            <router-link :to="{name:'food_category_edit',params:{id:props.row.id}}" class="button is-warning">Update</router-link>
        ...
        methods: {
            ...
            loadAsyncData() {
                ...
                this.$db('food_category')
                    .orWhere('category_name', 'like', '%'+this.search_text+'%')
                    .where('sts', 1)
                    .orderBy('id', 'desc')
                    .limit(500)
                    .then(data => {

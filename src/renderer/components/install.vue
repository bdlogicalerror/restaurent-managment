    ...
    <section  class="hero">
        ...
        <div class="hero-body">
            <div class="container">
                ...
                <div class="card" v-if="!db_install">
                    <header class="card-header">
                        <p class="card-header-title">
                            Install Goti-Restaurant
                        </p>
                    </header>
                    <div class="card-content">
                        <b-field label="Click to start">
                            <b-button @click="db_create_start" type="is-primary">Start</b-button>
                        </b-field>
                    </div>
                </div>

                <RestaurentInfo v-if="!restaurant_info&&db_install"></RestaurentInfo>
               <!-- <UserInfo v-if="!user_info&&restaurant_info"></UserInfo>-->
                <Login v-if="restaurant_info&&!login"></Login>
            </div>
        </div>
    </section>
</template>
    ...
    export default {
        ...
        data(){
            return{
                ...
                login:false,
                db_install:localStorage.getItem('start'),
